...
\begin{figure}[H]
\centering
\begin{tikzpicture}[x=0.40cm, y=0.7cm, every node/.style={font=\small}]
    ...
    \draw[fill=orange!30,draw=black] (10,5) rectangle (24,5.4);

    \node[left] at (-0.5,4) {Base Reference Implementation};
    \draw[fill=purple!30,draw=black] (6,3.8) rectangle (10,4.2);
    ...
    \draw[fill=green!30,draw=black] (2,0.8) rectangle (6,1.2);
...
Curriculum learning suggests training on progressively more complex positions. Within prioritized replay, curriculum strategies help evolve the sampling distribution over time, starting with uniform sampling and gradually shifting to more focused non-iid patterns.
